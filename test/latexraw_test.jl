...
@testset "Operators" begin
    @test latexraw(:(x ⊊ y)) == raw"\left( x \subsetneq y \right)"
    @test latexraw(:(x .⊆ y)) == raw"\left( x \subseteq y \right)"
    @test latexraw(:(x .∌ y)) == raw"\left( x \not\ni y \right)"
    @test latexraw(:(x .>= y)) == raw"\left( x \geq y \right)"
    @test latexraw(:(x .== y)) == raw"\left( x = y \right)"
    @test latexraw(:(issubset(x, y))) == raw"\left( x \subseteq y \right)"
    @test latexraw(:(x .∉ y)) == raw"\left( x \notin y \right)"
    @test latexraw(:(x < y)) == raw"\left( x < y \right)"
    @test latexraw(:(x !== y)) == raw"\left( x \not\equiv y \right)"
    @test latexraw(:(x ≈ y)) == raw"\left( x \approx y \right)"
    @test latexraw(:(x .⊅ y)) == raw"\left( x \not\supset y \right)"
    @test latexraw(:(x ≥ y)) == raw"\left( x \geq y \right)"
    @test latexraw(:(x >= y)) == raw"\left( x \geq y \right)"
    @test latexraw(:(x .∈ y)) == raw"\left( x \in y \right)"
    @test latexraw(:(x > y)) == raw"\left( x > y \right)"
    @test latexraw(:(x <= y)) == raw"\left( x \leq y \right)"
    @test latexraw(:(x .⊊ y)) == raw"\left( x \subsetneq y \right)"
    @test latexraw(:(x .<= y)) == raw"\left( x \leq y \right)"
    @test latexraw(:(x .≤ y)) == raw"\left( x \leq y \right)"
    @test latexraw(:(x ⊃ y)) == raw"\left( x \supset y \right)"
    @test latexraw(:(x == y)) == raw"\left( x = y \right)"
    @test latexraw(:(x in y)) == raw"\left( x \in y \right)"
    @test latexraw(:(x ≠ y)) == raw"\left( x \neq y \right)"
    @test latexraw(:(x ⊆ y)) == raw"\left( x \subseteq y \right)"
    @test latexraw(:(x .≥ y)) == raw"\left( x \geq y \right)"
    @test latexraw(:(x .< y)) == raw"\left( x < y \right)"
    @test latexraw(:(x != y)) == raw"\left( x \neq y \right)"
    @test latexraw(:(x .!== y)) == raw"\left( x \not\equiv y \right)"
    @test latexraw(:(x === y)) == raw"\left( x \equiv y \right)"
    @test latexraw(:(x ⊅ y)) == raw"\left( x \not\supset y \right)"
    @test latexraw(:(x .∋ y)) == raw"\left( x \ni y \right)"
    @test latexraw(:(x ∉ y)) == raw"\left( x \notin y \right)"
    @test latexraw(:(x .≠ y)) == raw"\left( x \neq y \right)"
